...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed top-0 left-[50%] translate-x-[-50%] z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:flex-col max-w-[500px]',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn('text-md sm:text-lg md:text-2xl font-semibold', className)}
    {...props}
  />
));
